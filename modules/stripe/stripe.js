 ...
 * @param {string} apiEndpoint - The API endpoint to create the payment intent
 * @returns {Promise<object>} - The client secret for the payment intent
 */
export const createPaymentIntent = async (orderId, token, apiEndpoint = '/api/payment/create-payment-intent') => {
  try {
